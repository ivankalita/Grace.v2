...
jQuery(function($){
    $(document).ready(function() {
        ...
        $('.age-sub').on('click', () => {
            ...
            if (age > 4 && age < 160) $('[name="contactAge"]').val(--age);
            else $('[name="contactAge"]').val(4);
        ...
        */
        $('[name="contactName"]').on('blur', function() {
            var nameVal = $(this).val();
            var regName = /^[а-яА-Я]/;
            var validName = regName.test(nameVal);
            var validCenzName = true;

            for (var i = 0; i < cenz.length; i++) {
                if (cenz[i] == nameVal.toLowerCase()) {
                    validCenzName = false;
                    break;
                }
            }
        ...
        */
        $('[name="contactSurname"]').on('blur', function() {
            var surnameVal = $(this).val();
            var regSurname = /^[а-яА-Я]/;
            var validSurname = regSurname.test(surnameVal);
            var validCenzSurname = true;

            for (var i = 0; i < cenz.length; i++) {
                if (cenz[i] == surnameVal.toLowerCase()) {
        ...
        */
        $('[name="contactAge"]').on('blur', validateAge);
        ...
        */
        $('[name="contactPhone"]').on('blur', function() {
