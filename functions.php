...
add_action('wp_ajax_showgallerypost', 'true_show_images');
add_action('wp_ajax_nopriv_showgallerypost', 'true_show_images');

add_action('wp_ajax_sendmail', 'true_send_request');
add_action('wp_ajax_nopriv_sendmail', 'true_send_request');

add_action('wp_ajax_daytime', 'true_get_time');
add_action('wp_ajax_nopriv_daytime', 'true_get_time');

add_filter('nav_menu_link_attributes', 'add_class_to_all_menu_anchors', 10 );
add_filter( 'nav_menu_css_class', 'add_my_class_to_nav_menu', 10, 2 );
add_filter('delete_wrap_filter', 'delete_wrapping_image', 20);
